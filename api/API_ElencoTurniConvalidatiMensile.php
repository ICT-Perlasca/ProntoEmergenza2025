...
function API_ElencoTurniConvalidatiMensile($get, $post, $session){
    if(!isset($post['idUtente']) || !isset($session['tipoUtente']) || $session['tipoUtente'] != "admin"){
        ...
        $sql = "SELECT t.idTurno118 AS id, t.data, t.oraInizio, t.oraFine, 'Turno 118' AS tipo_turno, tu.convalidato
                ...
                WHERE tu.convalidato = 1 AND MONTH(t.data) = ? AND YEAR(t.data) = ?
                ...
                WHERE tu.convalidato = 1 AND MONTH(e.data) = ? AND YEAR(e.data) = ?
                ...
                WHERE tu.convalidato = 1 AND MONTH(a.data) = ? AND YEAR(a.data) = ?
