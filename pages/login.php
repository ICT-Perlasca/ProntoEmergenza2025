        ...
        <div class="col-lg-6 col-12 bg-primary min-vh-100 align-middle px-5 py-5 rounded">
            <form action="#" method="POST" class="container-fluid row align-items-center justify-content-center" name="formLog" onsubmit="return loginJS(this)">
                <div class="col-12">
                    ...
                    <input type="text" id="inputUsername" placeholder="username" class="form-control text-secondary"aria-label="Username">
                </div>
                <div class="col-12">
                    <label for="inputPassword" class="form-label">Password</label>
                    <input type="password" id="inputPassword" placeholder="password" class="form-control  text-secondary" aria-label="Password">
                </div>
